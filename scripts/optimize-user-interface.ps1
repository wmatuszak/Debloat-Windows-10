#   Name: optimize-user-interface.ps1
#
#   Params:
#      -SkipMouse - Excludes mouse config changes
#      -SkipKeyboard - Excludes keyboard config changes
#      -SkipFileExplorer - Excludes file explorer changes
#      -SkipVolumeSlider - Excludes volume slider switch 
#      -DisableNotifications - Disable tile notifications
#
#   Description
...
Param(
  [switch]$SkipMouse,
  [switch]$SkipKeyboard,
  [switch]$SkipFileExplorer,
  [switch]$SkipVolumeSlider,
